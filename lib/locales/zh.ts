export const zh = {
  ...
  'onboarding.steps.home-input.title': '快速开始',
  'onboarding.steps.home-input.content': '在这里输入你想要生成的图表描述，支持中英文，描述越详细生成效果越好。',
  'onboarding.steps.home-send.title': '发送按钮',
  'onboarding.steps.home-send.content': '点击发送按钮或按 Enter 键，AI 将快速生成图表预览。',
  'onboarding.steps.home-templates.title': '快速模板',
  'onboarding.steps.home-templates.content': '点击模板可以快速生成预设类型的图表，适合快速体验。',
  'onboarding.steps.home-recent.title': '最近会话',
  'onboarding.steps.home-recent.content': '这里显示最近的会话记录，点击可以快速恢复之前的图表。',
  'onboarding.steps.home-history.title': '历史记录',
  'onboarding.steps.home-history.content': '点击查看所有历史会话，支持搜索和管理。',
  'onboarding.steps.home-settings.title': '设置',
  'onboarding.steps.home-settings.content': '点击进入设置页面，配置 LLM、外观、快捷键等。',
  'onboarding.steps.home-editor-btn.title': '进入编辑器',
  'onboarding.steps.home-editor-btn.content': '点击这里进入编辑器页面，那里有完整的图表编辑功能。',
  ...
  'onboarding.steps.editor-back.content': '点击返回首页。',
