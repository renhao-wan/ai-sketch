                  ...
                  {activeTab === 'shortcuts' && (
                    <div className="relative w-64">
                      ...
                      <input
                        ...
                        className="w-full pl-10 pr-4 py-2 rounded-xl border border-[var(--border)] bg-[var(--surface-warm)] text-[var(--fg)] placeholder-[var(--muted)] focus:outline-none focus:ring-2 focus:ring-inset focus:ring-[var(--accent-indigo)]/20 focus:border-[var(--accent-indigo)] hover:border-[var(--accent-indigo)]/20 text-sm transition-all duration-200"
                      />
                    </div>
                  )}
                </div>
