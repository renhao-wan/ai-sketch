...
const SHORTCUT_CATEGORIES: { id: string; labelKey: TranslationKey; icon: typeof Navigation; shortcutIds: string[] }[] = [
  ...
  },
  {
    ...
    icon: Settings,
    shortcutIds: ['open-settings', 'open-appearance', 'open-llm', 'open-conversations', 'open-data', 'open-about'],
  },
  {
    id: 'edit',
  ...
  {
    id: 'other',
    labelKey: 'shortcuts.category.other',
    icon: MoreHorizontal,
    shortcutIds: ['fullscreen', 'escape'],
  },
];
