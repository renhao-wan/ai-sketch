...
const SHORTCUT_CATEGORIES: { id: string; labelKey: TranslationKey; icon: typeof Navigation; shortcutIds: string[] }[] = [
  {
    ...
    icon: Navigation,
    shortcutIds: ['new-conversation', 'open-history', 'toggle-panel'],
  },
  {
    id: 'settings',
    labelKey: 'shortcuts.category.settings',
    icon: Settings,
    shortcutIds: ['open-settings', 'open-appearance', 'open-llm', 'open-conversations', 'open-tags', 'open-storage', 'open-ai-actions', 'open-shortcuts', 'open-network', 'open-about'],
  },
  {
    id: 'edit',
  ...
  },
  {
    ...
    icon: Monitor,
    shortcutIds: ['switch-excalidraw', 'switch-mermaid', 'switch-drawio', 'open-version-history'],
  },
  {
    id: 'window',
